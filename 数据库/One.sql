...
CREATE TABLE IF NOT EXISTS `mydb`.`user` (
  ...
  `head_url` VARCHAR(200) NOT NULL COMMENT '头像路径',
  `bg_url` VARCHAR(200) NOT NULL COMMENT '主页背景图片路径',
  `introduce` VARCHAR(500) NULL COMMENT '个人简介\n',
  `regist_date` TIMESTAMP NOT NULL COMMENT '注册日期',
...
CREATE TABLE IF NOT EXISTS `mydb`.`article` (
  ...
  `user_id` INT NOT NULL COMMENT '文章作者的用户名',
  `article_title` VARCHAR(50) NOT NULL COMMENT '文章的标题',
  `create_time` TIMESTAMP NOT NULL COMMENT '文章创建日期',
  `update_time` TIMESTAMP NOT NULL COMMENT '最近更新时间',
  `article_sum` TEXT(200) NOT NULL COMMENT '文章简介\n',
...
CREATE TABLE IF NOT EXISTS `mydb`.`article_comment` (
  ...
  `article_id` INT UNSIGNED NOT NULL COMMENT '文章的ID',
  `discusser` VARCHAR(25) NOT NULL COMMENT '发出评论的用户名',
  `comment` TEXT(500) NOT NULL COMMENT '评论正文500字',
  `create_time` TIMESTAMP NOT NULL COMMENT '评论的创建时间',
...
CREATE TABLE IF NOT EXISTS `mydb`.`article_reply` (
  ...
  `article_comment_id` INT UNSIGNED NOT NULL COMMENT '	评论的编号',
  `replier` INT NOT NULL COMMENT '发出回复的用户',
  `user_id` INT NOT NULL COMMENT '被回复的用户',
  `re_time` TIMESTAMP NOT NULL COMMENT '回复时间',
  `reply` TEXT(500) NOT NULL COMMENT '回复内容500字',
...
CREATE TABLE IF NOT EXISTS `mydb`.`attention` (
  ...
  `follower` INT NOT NULL COMMENT '发出关注的用户名（id）',
  `user_id` INT NOT NULL COMMENT '被关注的用户名（id）',
...
CREATE TABLE IF NOT EXISTS `mydb`.`one_level` (
  `id` INT NOT NULL AUTO_INCREMENT COMMENT '一级列表ID(主键)',
...
CREATE TABLE IF NOT EXISTS `mydb`.`two_level` (
  `id` INT NOT NULL AUTO_INCREMENT COMMENT '二级列表ID(主键)',
  `lv1` INT NOT NULL COMMENT '对应一级列表ID',
  `title` VARCHAR(45) NULL COMMENT '标题',
...
CREATE TABLE IF NOT EXISTS `mydb`.`course_collection` (
  `id` INT NOT NULL COMMENT '教程集合ID(主键)',
  `lv2` INT NOT NULL COMMENT '对应二级列表ID',
  `title` VARCHAR(45) NULL COMMENT '标题',
  `seq` VARCHAR(45) NULL COMMENT '序号',
...
CREATE TABLE IF NOT EXISTS `mydb`.`course_info` (
  `article_id` INT NOT NULL COMMENT '教程ID(主键)',
  `title` VARCHAR(45) NULL COMMENT '标题',
  `summary` VARCHAR(45) NULL COMMENT '摘要',
  `seq` INT NULL COMMENT '序号',
  `author_id` INT NOT NULL COMMENT '作者',
  `source` VARCHAR(45) NULL COMMENT '来源',
  `createdate` TIMESTAMP NULL COMMENT '创建日期',
  `re_up_time` TIMESTAMP NULL COMMENT '最后更新日期',
  `comments` INT NULL COMMENT '评论数',
  `viewnum` INT NULL COMMENT '浏览量',
  `content_url` TEXT(300) NULL COMMENT '内容的url',
  `lv3` INT NOT NULL COMMENT '对应三级列表ID',
  PRIMARY KEY (`article_id`),
...
CREATE TABLE IF NOT EXISTS `mydb`.`course_comment` (
  `cid` INT NOT NULL COMMENT '评论ID(主键)',
  `article_id` INT NOT NULL COMMENT '教程ID',
  `user_id` INT NOT NULL COMMENT '用户ID',
  `time` TIMESTAMP NULL COMMENT '评论日期',
...
CREATE TABLE IF NOT EXISTS `mydb`.`course_reply` (
  `rid` INT NOT NULL COMMENT '回复ID(主键)',
  `cid` INT NOT NULL COMMENT '评论ID',
  `re_user` INT NULL COMMENT '用户id',
  `by_re_user` INT NULL COMMENT '被回复的用户id',
  `re_time` TIMESTAMP NULL COMMENT '回复日期',
...
CREATE TABLE IF NOT EXISTS `mydb`.`reco_course` (
  `article_id` INT NOT NULL COMMENT '文章ID(主键)，外键当主键',
...
CREATE TABLE IF NOT EXISTS `mydb`.`article_draft` (
  ...
  `user_id` INT NOT NULL COMMENT '	文章作者的用户名',
  `title` VARCHAR(50) NOT NULL COMMENT '文章的标题\n',
  `create_time` TIMESTAMP NOT NULL COMMENT '文章创建日期',
  `update_time` TIMESTAMP NOT NULL COMMENT '最近更新时间',
...
CREATE TABLE IF NOT EXISTS `mydb`.`board` (
  ...
  `seq` VARCHAR(45) NOT NULL COMMENT '板块次序',
...
CREATE TABLE IF NOT EXISTS `mydb`.`qr_code` (
  ...
  `qr_img_url` VARCHAR(200) NULL COMMENT '二维码路径',
