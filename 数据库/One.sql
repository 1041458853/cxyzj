...
CREATE TABLE IF NOT EXISTS `mydb`.`user` (
  ...
  `regis_date` TIMESTAMP(6) NOT NULL COMMENT '注册日期',
...
CREATE TABLE IF NOT EXISTS `mydb`.`article` (
  ...
  `create_time` TIMESTAMP(6) NOT NULL COMMENT '文章添加日期,时间会自动充填，充填的时间为最近一次更新的时间',
  `re_up_time` TIMESTAMP(6) NOT NULL COMMENT '最近更新时间,时间会自动充填，充填的时间为最近一次更新的时间',
...
CREATE TABLE IF NOT EXISTS `mydb`.`article_comment` (
  ...
  `time` TIMESTAMP(6) NOT NULL COMMENT '评论时间,时间会自动充填，充填的时间为最近一次更新的时间',
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `mydb`.`article_reply` (
  ...
  `re_time` TIMESTAMP(6) NOT NULL COMMENT '回复时间,时间会自动充填，充填的时间为最近一次更新的时间',
...
CREATE TABLE IF NOT EXISTS `mydb`.`course_draft` (
  ...
  INDEX `fk_course_info_course_collection1_idx` (`lv3` ASC),
  INDEX `fk_course_info_user1_idx` (`author_id` ASC),
  CONSTRAINT `fk_course_info_course_collection10`
    FOREIGN KEY (`lv3`)
    REFERENCES `mydb`.`course_collection` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
CREATE TABLE IF NOT EXISTS `mydb`.`section` (
  ...
  `sec_img` VARCHAR(60) NOT NULL,
  `sec_title` VARCHAR(10) NOT NULL,
  `sec_url` VARCHAR(100) NOT NULL,
